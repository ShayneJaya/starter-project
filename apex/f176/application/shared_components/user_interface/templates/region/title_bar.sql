...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14382896350763163)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14383124152763163)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14383430473763163)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14383782065763163)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14384092776763163)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14384379682763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14384631082763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14384901398763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14385202173763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14385586153763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14385831901763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14386190528763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14386437213763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14386755585763164)
,p_plug_template_id=>wwv_flow_imp.id(14382896350763163)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
