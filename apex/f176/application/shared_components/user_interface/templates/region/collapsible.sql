...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14345427109763141)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14345720487763141)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14346081928763141)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14346345614763141)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14346691011763141)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14346998679763141)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14347270773763142)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14347543346763142)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14347811206763142)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14348181186763142)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14348418694763142)
,p_plug_template_id=>wwv_flow_imp.id(14345427109763141)
,p_name=>'Sub Regions'
