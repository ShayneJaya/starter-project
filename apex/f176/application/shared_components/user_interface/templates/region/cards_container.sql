...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14338967587763138)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14339218320763138)
,p_plug_template_id=>wwv_flow_imp.id(14338967587763138)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14339522095763138)
,p_plug_template_id=>wwv_flow_imp.id(14338967587763138)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14339821402763138)
,p_plug_template_id=>wwv_flow_imp.id(14338967587763138)
,p_name=>'Sub Regions'
