...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14390409954763167)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14390754670763167)
,p_plug_template_id=>wwv_flow_imp.id(14390409954763167)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14391072280763167)
,p_plug_template_id=>wwv_flow_imp.id(14390409954763167)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14391335975763167)
,p_plug_template_id=>wwv_flow_imp.id(14390409954763167)
,p_name=>'Sub Regions'
