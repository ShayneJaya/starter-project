...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14380227466763162)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14380589049763162)
,p_plug_template_id=>wwv_flow_imp.id(14380227466763162)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14380801228763162)
,p_plug_template_id=>wwv_flow_imp.id(14380227466763162)
,p_name=>'Tabs'
