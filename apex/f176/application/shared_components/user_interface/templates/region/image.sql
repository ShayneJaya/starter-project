...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14324875031763131)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14325131184763131)
,p_plug_template_id=>wwv_flow_imp.id(14324875031763131)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14325489169763132)
,p_plug_template_id=>wwv_flow_imp.id(14324875031763131)
,p_name=>'Sub Regions'
