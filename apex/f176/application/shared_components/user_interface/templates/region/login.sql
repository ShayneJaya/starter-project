...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14367955793763151)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14368244047763151)
,p_plug_template_id=>wwv_flow_imp.id(14367955793763151)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14368572448763151)
,p_plug_template_id=>wwv_flow_imp.id(14367955793763151)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14368803549763151)
,p_plug_template_id=>wwv_flow_imp.id(14367955793763151)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14369170744763151)
,p_plug_template_id=>wwv_flow_imp.id(14367955793763151)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14369449592763151)
,p_plug_template_id=>wwv_flow_imp.id(14367955793763151)
,p_name=>'Sub Regions'
