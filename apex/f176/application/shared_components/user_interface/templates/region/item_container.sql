...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14365450741763149)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14365788755763150)
,p_plug_template_id=>wwv_flow_imp.id(14365450741763149)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14366009959763150)
,p_plug_template_id=>wwv_flow_imp.id(14365450741763149)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14366396497763150)
,p_plug_template_id=>wwv_flow_imp.id(14365450741763149)
,p_name=>'Button Start'
