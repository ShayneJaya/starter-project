...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14358787644763147)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14359099247763147)
,p_plug_template_id=>wwv_flow_imp.id(14358787644763147)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14359342922763147)
,p_plug_template_id=>wwv_flow_imp.id(14358787644763147)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14359683926763147)
,p_plug_template_id=>wwv_flow_imp.id(14358787644763147)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14359933616763147)
,p_plug_template_id=>wwv_flow_imp.id(14358787644763147)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14360246836763147)
,p_plug_template_id=>wwv_flow_imp.id(14358787644763147)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14360574835763147)
,p_plug_template_id=>wwv_flow_imp.id(14358787644763147)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14360818137763148)
,p_plug_template_id=>wwv_flow_imp.id(14358787644763147)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14361175027763148)
,p_plug_template_id=>wwv_flow_imp.id(14358787644763147)
,p_name=>'Sub Regions'
