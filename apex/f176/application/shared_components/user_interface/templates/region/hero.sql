...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14355200491763145)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14355597549763145)
,p_plug_template_id=>wwv_flow_imp.id(14355200491763145)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14355838476763146)
,p_plug_template_id=>wwv_flow_imp.id(14355200491763145)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14356108362763146)
,p_plug_template_id=>wwv_flow_imp.id(14355200491763145)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14356423458763146)
,p_plug_template_id=>wwv_flow_imp.id(14355200491763145)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14356788368763146)
,p_plug_template_id=>wwv_flow_imp.id(14355200491763145)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
