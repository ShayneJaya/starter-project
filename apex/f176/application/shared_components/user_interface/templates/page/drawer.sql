...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14276016292763081)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14276357167763085)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14276687154763086)
,p_page_template_id=>wwv_flow_imp.id(14276016292763081)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14276907711763086)
,p_page_template_id=>wwv_flow_imp.id(14276016292763081)
