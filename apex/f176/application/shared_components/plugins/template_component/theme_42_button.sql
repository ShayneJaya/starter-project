...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14468914237763268)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14469210350763269)
,p_plugin_id=>wwv_flow_imp.id(14468914237763268)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14469551446763269)
,p_plugin_id=>wwv_flow_imp.id(14468914237763268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14469835113763270)
,p_plugin_id=>wwv_flow_imp.id(14468914237763268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14470137490763270)
,p_plugin_id=>wwv_flow_imp.id(14468914237763268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14470411354763270)
,p_plugin_id=>wwv_flow_imp.id(14468914237763268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14470761525763271)
,p_plugin_id=>wwv_flow_imp.id(14468914237763268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14471088173763271)
,p_plugin_id=>wwv_flow_imp.id(14468914237763268)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14471377726763271)
,p_plugin_id=>wwv_flow_imp.id(14468914237763268)
,p_attribute_scope=>'COMPONENT'
