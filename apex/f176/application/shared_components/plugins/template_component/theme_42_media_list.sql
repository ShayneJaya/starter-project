...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14481971943763289)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1814500341000646941)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1814499785988646940)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14482696020763292)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14482928358763293)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14483211714763293)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14483504377763293)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14483815079763294)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14483211714763293)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1814500341000646941)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14484119340763294)
,p_plugin_attribute_id=>wwv_flow_imp.id(14483815079763294)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14484509615763295)
,p_plugin_attribute_id=>wwv_flow_imp.id(14483815079763294)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14484904993763295)
,p_plugin_attribute_id=>wwv_flow_imp.id(14483815079763294)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14485373231763296)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14483815079763294)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14485677363763296)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14485974687763296)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14486203146763297)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14486579722763297)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14486880669763297)
,p_plugin_attribute_id=>wwv_flow_imp.id(14486579722763297)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14487287328763298)
,p_plugin_attribute_id=>wwv_flow_imp.id(14486579722763297)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14487625686763299)
,p_plugin_attribute_id=>wwv_flow_imp.id(14486579722763297)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14488004872763299)
,p_plugin_attribute_id=>wwv_flow_imp.id(14486579722763297)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14488477920763299)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(14483504377763293)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1814499785988646940)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14488746293763300)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14489010497763301)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14489358442763301)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14489611583763301)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14489909591763302)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14490268158763302)
,p_plugin_attribute_id=>wwv_flow_imp.id(14489909591763302)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14490630957763302)
,p_plugin_attribute_id=>wwv_flow_imp.id(14489909591763302)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14491014521763303)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14491377731763303)
,p_plugin_attribute_id=>wwv_flow_imp.id(14491014521763303)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14491733313763304)
,p_plugin_attribute_id=>wwv_flow_imp.id(14491014521763303)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14492146182763304)
,p_plugin_attribute_id=>wwv_flow_imp.id(14491014521763303)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14492524547763304)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14492835415763305)
,p_plugin_attribute_id=>wwv_flow_imp.id(14492524547763304)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14493222003763305)
,p_plugin_attribute_id=>wwv_flow_imp.id(14492524547763304)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14493636908763306)
,p_plugin_attribute_id=>wwv_flow_imp.id(14492524547763304)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14494078683763306)
,p_plugin_attribute_id=>wwv_flow_imp.id(14492524547763304)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14494460671763306)
,p_plugin_attribute_id=>wwv_flow_imp.id(14492524547763304)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14494845862763307)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14495151350763308)
,p_plugin_attribute_id=>wwv_flow_imp.id(14494845862763307)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14495568219763308)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1814703393157793569)
,p_plugin_id=>wwv_flow_imp.id(14481971943763289)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
