...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14514022169763339)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1941751844168835040)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1941751289156835039)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1684859225426561526)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14514972056763346)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14515285283763347)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14515582053763347)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14515883182763347)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14516193122763348)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14516435609763348)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14516736530763349)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14516193122763348)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1941751844168835040)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14517090841763349)
,p_plugin_attribute_id=>wwv_flow_imp.id(14516736530763349)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14517496432763349)
,p_plugin_attribute_id=>wwv_flow_imp.id(14516736530763349)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14517881691763349)
,p_plugin_attribute_id=>wwv_flow_imp.id(14516736530763349)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14518288100763350)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14516736530763349)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14518591890763350)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14518878515763350)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14519173607763351)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14519433831763351)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14519745315763351)
,p_plugin_attribute_id=>wwv_flow_imp.id(14519433831763351)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14520108403763351)
,p_plugin_attribute_id=>wwv_flow_imp.id(14519433831763351)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14520510742763352)
,p_plugin_attribute_id=>wwv_flow_imp.id(14519433831763351)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14520973170763352)
,p_plugin_attribute_id=>wwv_flow_imp.id(14519433831763351)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14521321577763352)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(14516435609763348)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1941751289156835039)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14521653583763353)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14521971155763353)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14522238081763353)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14522543900763353)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14522899403763354)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14523127147763354)
,p_plugin_attribute_id=>wwv_flow_imp.id(14522899403763354)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14523549522763354)
,p_plugin_attribute_id=>wwv_flow_imp.id(14522899403763354)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14523986508763355)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14524273778763355)
,p_plugin_attribute_id=>wwv_flow_imp.id(14523986508763355)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14524630475763355)
,p_plugin_attribute_id=>wwv_flow_imp.id(14523986508763355)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14525096043763356)
,p_plugin_attribute_id=>wwv_flow_imp.id(14523986508763355)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14525424349763356)
,p_plugin_attribute_id=>wwv_flow_imp.id(14523986508763355)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14525860193763356)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14526106421763357)
,p_plugin_attribute_id=>wwv_flow_imp.id(14525860193763356)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14526597836763357)
,p_plugin_attribute_id=>wwv_flow_imp.id(14525860193763356)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14526999939763357)
,p_plugin_attribute_id=>wwv_flow_imp.id(14525860193763356)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14527364024763358)
,p_plugin_attribute_id=>wwv_flow_imp.id(14525860193763356)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14527704950763358)
,p_plugin_attribute_id=>wwv_flow_imp.id(14525860193763356)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14528107391763358)
,p_plugin_attribute_id=>wwv_flow_imp.id(14525860193763356)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14528537916763359)
,p_plugin_attribute_id=>wwv_flow_imp.id(14525860193763356)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14528901054763359)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14529215374763359)
,p_plugin_attribute_id=>wwv_flow_imp.id(14528901054763359)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14529601225763360)
,p_plugin_attribute_id=>wwv_flow_imp.id(14528901054763359)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14530084054763360)
,p_plugin_attribute_id=>wwv_flow_imp.id(14528901054763359)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14530477999763360)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14530757115763361)
,p_plugin_attribute_id=>wwv_flow_imp.id(14530477999763360)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14531184045763361)
,p_plugin_attribute_id=>wwv_flow_imp.id(14530477999763360)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14531577300763362)
,p_plugin_attribute_id=>wwv_flow_imp.id(14530477999763360)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14531979969763362)
,p_plugin_attribute_id=>wwv_flow_imp.id(14530477999763360)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14532309738763363)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14532668942763363)
,p_plugin_attribute_id=>wwv_flow_imp.id(14532309738763363)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14533045068763363)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14533304896763363)
,p_plugin_attribute_id=>wwv_flow_imp.id(14533045068763363)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14533762901763364)
,p_plugin_attribute_id=>wwv_flow_imp.id(14533045068763363)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14534129913763364)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1684859225426561526)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14534400530763364)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14534796288763365)
,p_plugin_attribute_id=>wwv_flow_imp.id(14534400530763364)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14535159997763365)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14535445086763365)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1822965734384656654)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1822966993904660802)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1526014219488898224)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1809372105710249921)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1810051406440333025)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1822963799317611668)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1822965132707625525)
,p_plugin_id=>wwv_flow_imp.id(14514022169763339)
