...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14453706974763220)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14454003994763230)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14454313204763231)
,p_plugin_attribute_id=>wwv_flow_imp.id(14454003994763230)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14454751934763234)
,p_plugin_attribute_id=>wwv_flow_imp.id(14454003994763230)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14455109383763234)
,p_plugin_attribute_id=>wwv_flow_imp.id(14454003994763230)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14455506178763235)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14454003994763230)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14455894176763235)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14456168904763235)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14456419892763236)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14456754133763236)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14457092188763236)
,p_plugin_attribute_id=>wwv_flow_imp.id(14456754133763236)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14457457158763236)
,p_plugin_attribute_id=>wwv_flow_imp.id(14456754133763236)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14457833656763237)
,p_plugin_attribute_id=>wwv_flow_imp.id(14456754133763236)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14458224037763237)
,p_plugin_attribute_id=>wwv_flow_imp.id(14456754133763236)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14458647262763238)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14458977483763238)
,p_plugin_attribute_id=>wwv_flow_imp.id(14458647262763238)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14459362427763238)
,p_plugin_attribute_id=>wwv_flow_imp.id(14458647262763238)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14459704096763238)
,p_plugin_attribute_id=>wwv_flow_imp.id(14458647262763238)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14460137993763239)
,p_plugin_attribute_id=>wwv_flow_imp.id(14458647262763238)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14460531202763239)
,p_plugin_attribute_id=>wwv_flow_imp.id(14458647262763238)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14460997644763239)
,p_plugin_attribute_id=>wwv_flow_imp.id(14458647262763238)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14461348072763240)
,p_plugin_attribute_id=>wwv_flow_imp.id(14458647262763238)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14461700108763240)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1814504660078876975)
,p_plugin_id=>wwv_flow_imp.id(14453706974763220)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
