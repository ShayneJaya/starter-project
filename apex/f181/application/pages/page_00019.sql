...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2892902229390517618)
,p_name=>'&APP_NAME.'
,p_template=>wwv_flow_imp.id(32900026305813941)
...
,p_query_row_template=>wwv_flow_imp.id(32974573015813975)
,p_query_num_rows=>15
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(39107651837847295)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(39108031432847295)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(39108494762847295)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4084050214120895487)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4084050605229895488)
,p_plug_name=>'Quick Start'
,p_parent_plug_id=>wwv_flow_imp.id(4084050214120895487)
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<H2>Getting Started</h2>',
'<p>Run the application as a developer; at the bottom of the page will be buttons for viewing the page in the Application Express Application Builder. Click on the "Edit Page #" button to see how the pages are defined.</p>',
''))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4084050802451895488)
...
'<p>',
'    <ul>',
'        <li>Simple Map Visualizations: Markers, Polygons, Heat Maps.</li>',
'        <li>Show Map object details using Tool Tips and Information Windows.</li>',
'        <li>Use <strong>Faceted Search</strong> with a Map.</li>',
'        <li>Use Interactive Reports to look up an object and show it on the Map.</li>',
'        <li>Connect a report: Always show what''s visible on the Map.</li>',
'        <li>"Circle Search": Draw a circle on the map and use Spatial SQL to find objects within.</li>',
'        <li>Find Nearest Neighbors, based from a given point.</li>',
'        <li>Use Custom Map Markers.</li>',
'    </ul>',
'</p>'))
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4084050999362895488)
...
'<p>This application contains numerous examples of visualizing coordinate data on a map. Use Map Markers, Lines or Polygons, or the Heat Map feature. The APEX <strong>Map Region</strong> can easily be combined with Oracle Spatial functionality (which '
||'is included in every Oracle Database) to perform a "Within Distance Search", "Nearest Neighbor Search", or other spatial analysis.</p>'))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML',
  'show_line_breaks', 'N')).to_clob
