...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(33008543390814007)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38906040071405554)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38906541372405556)
,p_plugin_attribute_id=>wwv_flow_imp.id(38906040071405554)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38907138674405557)
,p_plugin_attribute_id=>wwv_flow_imp.id(38906040071405554)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38907709266405557)
,p_plugin_attribute_id=>wwv_flow_imp.id(38906040071405554)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38908309839405558)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(38906040071405554)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38908825033405559)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38909302203405559)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38909858610405559)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38910350308405560)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38910825350405560)
,p_plugin_attribute_id=>wwv_flow_imp.id(38910350308405560)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38911487380405561)
,p_plugin_attribute_id=>wwv_flow_imp.id(38910350308405560)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38912042562405561)
,p_plugin_attribute_id=>wwv_flow_imp.id(38910350308405560)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38912619968405562)
,p_plugin_attribute_id=>wwv_flow_imp.id(38910350308405560)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38913208425405563)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38913704030405564)
,p_plugin_attribute_id=>wwv_flow_imp.id(38913208425405563)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38914349406405565)
,p_plugin_attribute_id=>wwv_flow_imp.id(38913208425405563)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38914913977405565)
,p_plugin_attribute_id=>wwv_flow_imp.id(38913208425405563)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38915597674405566)
,p_plugin_attribute_id=>wwv_flow_imp.id(38913208425405563)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38916130286405566)
,p_plugin_attribute_id=>wwv_flow_imp.id(38913208425405563)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38916774779405567)
,p_plugin_attribute_id=>wwv_flow_imp.id(38913208425405563)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38917366342405567)
,p_plugin_attribute_id=>wwv_flow_imp.id(38913208425405563)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38917944638405568)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1833059369634927764)
,p_plugin_id=>wwv_flow_imp.id(33008543390814007)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
