...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(33063430173814111)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1839013762127289334)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1839013207115289333)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38996404635405686)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38996930798405687)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38997412749405687)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38997924522405688)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38998464221405688)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(38997412749405687)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1839013762127289334)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38998927855405689)
,p_plugin_attribute_id=>wwv_flow_imp.id(38998464221405688)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38999506974405689)
,p_plugin_attribute_id=>wwv_flow_imp.id(38998464221405688)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39000166458405690)
,p_plugin_attribute_id=>wwv_flow_imp.id(38998464221405688)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39000759004405690)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(38998464221405688)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39001273882405691)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39001736845405691)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39002244339405692)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39002760242405692)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39003292365405693)
,p_plugin_attribute_id=>wwv_flow_imp.id(39002760242405692)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39003881343405693)
,p_plugin_attribute_id=>wwv_flow_imp.id(39002760242405692)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39004470507405694)
,p_plugin_attribute_id=>wwv_flow_imp.id(39002760242405692)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39005064479405694)
,p_plugin_attribute_id=>wwv_flow_imp.id(39002760242405692)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39005670825405695)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(38997924522405688)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1839013207115289333)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39006123308405695)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39006676309405695)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39007138692405696)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39007638689405696)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39008174704405697)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39008676078405697)
,p_plugin_attribute_id=>wwv_flow_imp.id(39008174704405697)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39009234679405698)
,p_plugin_attribute_id=>wwv_flow_imp.id(39008174704405697)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39009869726405698)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39010344351405699)
,p_plugin_attribute_id=>wwv_flow_imp.id(39009869726405698)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39010930993405699)
,p_plugin_attribute_id=>wwv_flow_imp.id(39009869726405698)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39011544731405700)
,p_plugin_attribute_id=>wwv_flow_imp.id(39009869726405698)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39012152266405700)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39012656845405701)
,p_plugin_attribute_id=>wwv_flow_imp.id(39012152266405700)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39013248049405701)
,p_plugin_attribute_id=>wwv_flow_imp.id(39012152266405700)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39013857810405702)
,p_plugin_attribute_id=>wwv_flow_imp.id(39012152266405700)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39014487937405702)
,p_plugin_attribute_id=>wwv_flow_imp.id(39012152266405700)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39015044863405703)
,p_plugin_attribute_id=>wwv_flow_imp.id(39012152266405700)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39015654281405703)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39016163824405704)
,p_plugin_attribute_id=>wwv_flow_imp.id(39015654281405703)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39016747557405704)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1833284882589844391)
,p_plugin_id=>wwv_flow_imp.id(33063430173814111)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
