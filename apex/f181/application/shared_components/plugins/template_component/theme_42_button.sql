...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(33023721559814053)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38929985496405594)
,p_plugin_id=>wwv_flow_imp.id(33023721559814053)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38930436229405595)
,p_plugin_id=>wwv_flow_imp.id(33023721559814053)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38930905929405595)
,p_plugin_id=>wwv_flow_imp.id(33023721559814053)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38931446549405596)
,p_plugin_id=>wwv_flow_imp.id(33023721559814053)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38931969805405596)
,p_plugin_id=>wwv_flow_imp.id(33023721559814053)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38932417805405596)
,p_plugin_id=>wwv_flow_imp.id(33023721559814053)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38932975180405597)
,p_plugin_id=>wwv_flow_imp.id(33023721559814053)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38933453450405597)
,p_plugin_id=>wwv_flow_imp.id(33023721559814053)
,p_attribute_scope=>'COMPONENT'
