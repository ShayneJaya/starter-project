...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(33036722199814074)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1966189034688477321)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1966188479676477320)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1709296415946203807)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38952747947405629)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38953236964405630)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38953760718405630)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38954231666405631)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38954758796405631)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38955277127405631)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38955768398405632)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(38954758796405631)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1966189034688477321)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38956230038405632)
,p_plugin_attribute_id=>wwv_flow_imp.id(38955768398405632)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38956852579405633)
,p_plugin_attribute_id=>wwv_flow_imp.id(38955768398405632)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38957436185405634)
,p_plugin_attribute_id=>wwv_flow_imp.id(38955768398405632)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38958021457405634)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(38955768398405632)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38958561667405635)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38959008444405635)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38959510579405636)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38960097527405636)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38960560798405637)
,p_plugin_attribute_id=>wwv_flow_imp.id(38960097527405636)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38961199110405637)
,p_plugin_attribute_id=>wwv_flow_imp.id(38960097527405636)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38961735015405639)
,p_plugin_attribute_id=>wwv_flow_imp.id(38960097527405636)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38962396952405639)
,p_plugin_attribute_id=>wwv_flow_imp.id(38960097527405636)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38962917261405639)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(38955277127405631)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1966188479676477320)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38963458473405640)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38963982342405640)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38964448688405641)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38964992759405641)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38965423472405642)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38965962682405642)
,p_plugin_attribute_id=>wwv_flow_imp.id(38965423472405642)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38966513872405642)
,p_plugin_attribute_id=>wwv_flow_imp.id(38965423472405642)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38967140550405644)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38967698109405645)
,p_plugin_attribute_id=>wwv_flow_imp.id(38967140550405644)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38968213079405646)
,p_plugin_attribute_id=>wwv_flow_imp.id(38967140550405644)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38968824402405646)
,p_plugin_attribute_id=>wwv_flow_imp.id(38967140550405644)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38969488798405647)
,p_plugin_attribute_id=>wwv_flow_imp.id(38967140550405644)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38970086225405647)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38970509659405648)
,p_plugin_attribute_id=>wwv_flow_imp.id(38970086225405647)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38971101487405650)
,p_plugin_attribute_id=>wwv_flow_imp.id(38970086225405647)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38971702387405650)
,p_plugin_attribute_id=>wwv_flow_imp.id(38970086225405647)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38972305307405651)
,p_plugin_attribute_id=>wwv_flow_imp.id(38970086225405647)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38972974814405651)
,p_plugin_attribute_id=>wwv_flow_imp.id(38970086225405647)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38973521023405652)
,p_plugin_attribute_id=>wwv_flow_imp.id(38970086225405647)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38974113725405652)
,p_plugin_attribute_id=>wwv_flow_imp.id(38970086225405647)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38974739072405653)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38975248920405654)
,p_plugin_attribute_id=>wwv_flow_imp.id(38974739072405653)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38975813653405655)
,p_plugin_attribute_id=>wwv_flow_imp.id(38974739072405653)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38976476752405656)
,p_plugin_attribute_id=>wwv_flow_imp.id(38974739072405653)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38977083338405657)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38977534392405657)
,p_plugin_attribute_id=>wwv_flow_imp.id(38977083338405657)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38978168234405658)
,p_plugin_attribute_id=>wwv_flow_imp.id(38977083338405657)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38978747390405658)
,p_plugin_attribute_id=>wwv_flow_imp.id(38977083338405657)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38979330075405659)
,p_plugin_attribute_id=>wwv_flow_imp.id(38977083338405657)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38979999427405659)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38980487819405660)
,p_plugin_attribute_id=>wwv_flow_imp.id(38979999427405659)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38981046978405661)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38981525390405661)
,p_plugin_attribute_id=>wwv_flow_imp.id(38981046978405661)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38982142941405662)
,p_plugin_attribute_id=>wwv_flow_imp.id(38981046978405661)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38982740855405662)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1709296415946203807)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38983291971405663)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(38983741532405664)
,p_plugin_attribute_id=>wwv_flow_imp.id(38983291971405663)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38984324205405666)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(38984860243405666)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1841488453838707389)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1841489713358711537)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1544536938942948959)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1827894825164300656)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1828574125894383760)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1841486518771662403)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1841487852161676260)
,p_plugin_id=>wwv_flow_imp.id(33036722199814074)
