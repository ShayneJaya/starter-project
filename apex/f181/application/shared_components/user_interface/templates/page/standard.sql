...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(32856664565813918)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38537660736405292)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38538168677405292)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38538670932405292)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38539138286405292)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38539623220405293)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38540174352405293)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38540673670405293)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38541110495405293)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38541651898405293)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38542177794405294)
,p_page_template_id=>wwv_flow_imp.id(32856664565813918)
