...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(32837474127813908)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38485789109405266)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38486205163405267)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38486719266405267)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38487213315405267)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38487704751405267)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38488233913405267)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38488717062405267)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38489243632405268)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38489715017405268)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38490259413405268)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38490715396405268)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38491281871405269)
,p_page_template_id=>wwv_flow_imp.id(32837474127813908)
