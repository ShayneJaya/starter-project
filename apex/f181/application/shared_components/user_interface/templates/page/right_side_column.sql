...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(32852911657813916)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38527513025405287)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38528072172405287)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38528539815405287)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38529073900405288)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38529521182405288)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38530015986405288)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38530552776405288)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38531001289405288)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38531581083405289)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38532042734405289)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38532540116405289)
,p_page_template_id=>wwv_flow_imp.id(32852911657813916)
