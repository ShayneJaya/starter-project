...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(32848074244813914)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38513905042405281)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38514490994405281)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38514969669405281)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38515427394405281)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38515922674405282)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38516467795405282)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38516927859405282)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38517458014405282)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38517985264405282)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38518443016405283)
,p_page_template_id=>wwv_flow_imp.id(32848074244813914)
