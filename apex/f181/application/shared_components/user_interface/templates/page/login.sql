...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(32841410765813910)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38493922801405270)
,p_page_template_id=>wwv_flow_imp.id(32841410765813910)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38494496411405270)
,p_page_template_id=>wwv_flow_imp.id(32841410765813910)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38494946940405270)
,p_page_template_id=>wwv_flow_imp.id(32841410765813910)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38495420180405271)
,p_page_template_id=>wwv_flow_imp.id(32841410765813910)
,p_name=>'Body Footer'
