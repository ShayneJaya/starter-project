...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(32833769739813906)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38474824494405260)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38475337066405261)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38475892776405261)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38476378078405261)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38476864445405261)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38477301973405262)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38477806990405262)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38478302628405262)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38478820189405262)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38479370578405262)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38479846394405263)
,p_page_template_id=>wwv_flow_imp.id(32833769739813906)
