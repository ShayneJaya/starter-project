...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32943176440813959)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38758479614405419)
,p_plug_template_id=>wwv_flow_imp.id(32943176440813959)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38758919891405420)
,p_plug_template_id=>wwv_flow_imp.id(32943176440813959)
,p_name=>'Tabs'
