...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32913564504813947)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38681925995405377)
,p_plug_template_id=>wwv_flow_imp.id(32913564504813947)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38682460184405378)
,p_plug_template_id=>wwv_flow_imp.id(32913564504813947)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38682915011405378)
,p_plug_template_id=>wwv_flow_imp.id(32913564504813947)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683419720405378)
,p_plug_template_id=>wwv_flow_imp.id(32913564504813947)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38683939223405378)
,p_plug_template_id=>wwv_flow_imp.id(32913564504813947)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38684467856405378)
,p_plug_template_id=>wwv_flow_imp.id(32913564504813947)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38684924275405379)
,p_plug_template_id=>wwv_flow_imp.id(32913564504813947)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38685480783405379)
,p_plug_template_id=>wwv_flow_imp.id(32913564504813947)
,p_name=>'Sub Regions'
