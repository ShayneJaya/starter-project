...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32925622440813952)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38711726263405393)
,p_plug_template_id=>wwv_flow_imp.id(32925622440813952)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38712276675405393)
,p_plug_template_id=>wwv_flow_imp.id(32925622440813952)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38712761484405394)
,p_plug_template_id=>wwv_flow_imp.id(32925622440813952)
,p_name=>'Button Start'
