...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32900026305813941)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38647511857405358)
,p_plug_template_id=>wwv_flow_imp.id(32900026305813941)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38648071582405359)
,p_plug_template_id=>wwv_flow_imp.id(32900026305813941)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38648566681405359)
,p_plug_template_id=>wwv_flow_imp.id(32900026305813941)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38649026934405359)
,p_plug_template_id=>wwv_flow_imp.id(32900026305813941)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38649562801405359)
,p_plug_template_id=>wwv_flow_imp.id(32900026305813941)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
