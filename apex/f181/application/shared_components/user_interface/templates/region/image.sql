...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32903579838813943)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38655032326405362)
,p_plug_template_id=>wwv_flow_imp.id(32903579838813943)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38655509835405363)
,p_plug_template_id=>wwv_flow_imp.id(32903579838813943)
,p_name=>'Sub Regions'
