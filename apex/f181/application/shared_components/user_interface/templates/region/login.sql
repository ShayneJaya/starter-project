...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32928177740813953)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38718575001405397)
,p_plug_template_id=>wwv_flow_imp.id(32928177740813953)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38719031893405397)
,p_plug_template_id=>wwv_flow_imp.id(32928177740813953)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38719507084405397)
,p_plug_template_id=>wwv_flow_imp.id(32928177740813953)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38720073860405397)
,p_plug_template_id=>wwv_flow_imp.id(32928177740813953)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38720523716405397)
,p_plug_template_id=>wwv_flow_imp.id(32928177740813953)
,p_name=>'Sub Regions'
