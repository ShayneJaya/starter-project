...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32945791020813960)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38768260906405425)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38768700745405425)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38769258175405425)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38769734919405425)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770211518405425)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770703851405426)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38771202987405426)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38771721436405426)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38772215326405427)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38772705869405427)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38773249163405427)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38773757089405427)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38774226248405427)
,p_plug_template_id=>wwv_flow_imp.id(32945791020813960)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
