...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32930636464813954)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38724376306405400)
,p_plug_template_id=>wwv_flow_imp.id(32930636464813954)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38724833637405400)
,p_plug_template_id=>wwv_flow_imp.id(32930636464813954)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38725326897405400)
,p_plug_template_id=>wwv_flow_imp.id(32930636464813954)
,p_name=>'Sub Regions'
