...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32873823201813928)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38579523401405319)
,p_plug_template_id=>wwv_flow_imp.id(32873823201813928)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38580044783405319)
,p_plug_template_id=>wwv_flow_imp.id(32873823201813928)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38580568354405320)
,p_plug_template_id=>wwv_flow_imp.id(32873823201813928)
,p_name=>'Sub Regions'
