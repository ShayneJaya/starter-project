...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(32885691070813935)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38611790276405338)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38612202099405338)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38612739104405339)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38613250377405339)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38613731341405339)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38614260133405339)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38614716399405339)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38615216471405340)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38615730594405340)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38616269930405340)
,p_plug_template_id=>wwv_flow_imp.id(32885691070813935)
,p_name=>'Sub Regions'
