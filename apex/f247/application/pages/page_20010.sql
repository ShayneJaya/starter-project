...
,p_group_id=>wwv_flow_imp.id(38063163577106288)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38064637453106282)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38065068665106280)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(38064387708106283)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(38065534343106278)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(38065068665106280)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(38065848002106277)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38066345790106276)
,p_event_id=>wwv_flow_imp.id(38065848002106277)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38066864418106274)
,p_event_id=>wwv_flow_imp.id(38065848002106277)
