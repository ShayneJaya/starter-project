...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1541004185154698969)
,p_plug_name=>'Info'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1541004261590698970)
,p_plug_name=>'Info'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--info:t-Alert--accessibleHeading'
,p_plug_template=>2040683448887306517
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1541004411003698971)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'selected_node_page_item', 'P3_SELECTED_EMPNO',
  'tree_hierarchy', 'LEVEL',
  'tree_tooltip', 'N')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1623596452455709765)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1603891626142984244)
,p_plug_name=>'Operations Team'
,p_parent_plug_id=>wwv_flow_imp.id(1623596452455709765)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1623596398709709764)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(38073076603091308)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1541008155540698935)
,p_name=>'P3_SELECTED_USERNAME'
,p_item_sequence=>60
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1573448154892978603)
,p_name=>'P3_SELECTED_EMPNO'
,p_item_sequence=>70
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(38076634743091270)
,p_computation_sequence=>10
,p_computation_item=>'P3_SELECTED_EMPNO'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'ITEM_VALUE'
,p_computation=>'CURRENT_USER_EMPNO'
);
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(38077014561091269)
,p_computation_sequence=>20
,p_computation_item=>'P3_SELECTED_USERNAME'
,p_computation_point=>'BEFORE_HEADER'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(38081626138091257)
,p_name=>'When Node Changed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(1541004411003698971)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_JSTREE|REGION TYPE|treeviewselectionchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38082167810091254)
,p_event_id=>wwv_flow_imp.id(38081626138091257)
,p_event_result=>'TRUE'
...
,p_affected_elements=>'P3_SELECTED_USERNAME'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38082687820091253)
,p_event_id=>wwv_flow_imp.id(38081626138091257)
,p_event_result=>'TRUE'
...
,p_affected_button_id=>wwv_flow_imp.id(38073076603091308)
,p_client_condition_type=>'EQUALS'
,p_client_condition_element=>'P3_SELECTED_USERNAME'
,p_client_condition_expression=>'&APP_USER.'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38083139680091252)
,p_event_id=>wwv_flow_imp.id(38081626138091257)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38083638106091251)
,p_event_id=>wwv_flow_imp.id(38081626138091257)
,p_event_result=>'TRUE'
...
,p_attribute_01=>'$("#loginButton span").text(''Login as ''+$v(''P3_SELECTED_USERNAME''));'
,p_client_condition_type=>'NOT_EQUALS'
,p_client_condition_element=>'P3_SELECTED_USERNAME'
,p_client_condition_expression=>'&APP_USER.'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38084185110091250)
,p_event_id=>wwv_flow_imp.id(38081626138091257)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(38084558205091249)
,p_name=>'Expand Tree'
,p_event_sequence=>20
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38085072840091248)
,p_event_id=>wwv_flow_imp.id(38084558205091249)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_name=>'Expand Tree'
...
,p_affected_region_id=>wwv_flow_imp.id(1541004411003698971)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(38077331016091269)
...
,p_internal_uid=>38077331016091269
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(38077804460091267)
,p_page_process_id=>wwv_flow_imp.id(38077331016091269)
,p_page_id=>3
,p_name=>'p_username'
,p_direction=>'IN'
...
,p_value=>'lower( :P3_SELECTED_USERNAME )'
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(38078346303091266)
,p_page_process_id=>wwv_flow_imp.id(38077331016091269)
,p_page_id=>3
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(38078888664091264)
,p_page_process_id=>wwv_flow_imp.id(38077331016091269)
,p_page_id=>3
,p_name=>'p_consent'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(38079206831091264)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>38079206831091264
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(38079738693091262)
,p_page_process_id=>wwv_flow_imp.id(38079206831091264)
,p_page_id=>3
,p_name=>'p_username'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
,p_display_sequence=>10
,p_value_type=>'ITEM'
,p_value=>'P3_SELECTED_USERNAME'
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(38080282357091261)
,p_page_process_id=>wwv_flow_imp.id(38079206831091264)
,p_page_id=>3
,p_name=>'p_password'
,p_direction=>'IN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(38080753367091260)
,p_page_process_id=>wwv_flow_imp.id(38079206831091264)
,p_page_id=>3
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(38081205420091259)
,p_page_process_id=>wwv_flow_imp.id(38079206831091264)
,p_page_id=>3
