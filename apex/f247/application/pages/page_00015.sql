...
wwv_flow_imp_page.create_page(
 p_id=>15
,p_name=>'Partial Refresh Example AJAX COPY'
,p_alias=>'PARTIAL-REFRESH-EXAMPLE-AJAX-COPY'
,p_step_title=>'Partial Refresh Example AJAX COPY'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(74782753028908884)
...
'',
'  <!-- Heavy CSS Libraries -->',
'<!--   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css" integrity="sha512-b+YkVKxtZiH3C/Ep15mE0povrqYJ2N2F6zXradd2bQhB4aD+mTBSJqQw9HhDNqXPN1sVXKqPKkrnwFhtK/1nE2g==" crossorigin="anonymous" referre'
||'rpolicy="no-referrer" />',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(83395023670810957)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(83396576325810946)
,p_plug_name=>'Search'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(83397335105810941)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41751371127021232)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41751738766021228)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41752190050021227)
,p_query_column_id=>3
,p_column_alias=>'LINK'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41752532729021226)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41752947685021224)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41753349816021222)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41753719033021220)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41754199928021218)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41754518975021216)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41754960788021214)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(83401998283810324)
...
,p_query_where=>'"CUSTOMER_ID" = :P15_CUSTOMER_ID'
,p_include_rowid_column=>false
,p_display_when_condition=>'P15_CUSTOMER_ID'
,p_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P15_CUSTOMER_ID'
,p_lazy_loading=>false
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41755718848021209)
,p_query_column_id=>1
,p_column_alias=>'CUSTOMER_ID'
,p_column_display_sequence=>1
...
'and "CUSTOMER_ID" = :P15_CUSTOMER_ID'))
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41756191416021208)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41756531071021206)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41756948470021204)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41757334170021203)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41757796299021201)
,p_query_column_id=>6
,p_column_alias=>'CITY'
,p_column_display_sequence=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41758125474021199)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41758554353021198)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41758921381021196)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41759393664021194)
,p_query_column_id=>10
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41759780134021192)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41760134163021191)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41760535381021189)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41760902612021187)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(83417212372810273)
...
,p_plug_display_when_condition=>'P15_CUSTOMER_ID'
,p_ai_enabled=>false
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(83417596483810270)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41762858630021176)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41763256202021174)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41763644379021173)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41764095020021172)
,p_query_column_id=>4
,p_column_alias=>'CUSTOMER_ID'
,p_column_display_sequence=>4
,p_column_heading=>'Customer Id'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41764415024021170)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41764863736021169)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41765223511021168)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(41765698135021167)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(83437609347809909)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(41766038120021166)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(83417596483810270)
...
,p_button_redirect_url=>'f?p=&APP_ID.:13:&APP_SESSION.::&DEBUG.:RP,13:P13_CUSTOMER_ID:&P15_CUSTOMER_ID.'
,p_icon_css_classes=>'fa-plus'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(41761380025021185)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(83401998283810324)
,p_button_name=>'EDIT'
...
,p_button_position=>'EDIT'
,p_button_redirect_url=>'f?p=&APP_ID.:12:&APP_SESSION.::&DEBUG.:RP,12:P12_CUSTOMER_ID:&P15_CUSTOMER_ID.'
,p_icon_css_classes=>'fa-pencil-square-o'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(41749596988021261)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(83395023670810957)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
...
,p_button_redirect_url=>'f?p=&APP_ID.:15:&APP_SESSION.:RESET:&DEBUG.:RP,7::'
,p_icon_css_classes=>'fa-undo-alt'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(41749927628021256)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(83395023670810957)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(83399135823810845)
,p_name=>'P15_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(83396576325810946)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(83430128162810117)
,p_name=>'P15_CUSTOMER_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(83401998283810324)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(41769012552021141)
,p_name=>'Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(83401998283810324)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(41769518690021140)
,p_event_id=>wwv_flow_imp.id(41769012552021141)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(83401998283810324)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(41770020166021139)
,p_event_id=>wwv_flow_imp.id(41769012552021141)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(41767796245021149)
,p_name=>'Dialog Closed'
,p_event_sequence=>40
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(83417596483810270)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(41768254164021144)
,p_event_id=>wwv_flow_imp.id(41767796245021149)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(83417596483810270)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(41768690375021142)
,p_event_id=>wwv_flow_imp.id(41767796245021149)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(41770470834021138)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(41770982799021136)
,p_event_id=>wwv_flow_imp.id(41770470834021138)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(83397335105810941)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(41771445930021135)
,p_event_id=>wwv_flow_imp.id(41770470834021138)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(41771965271015902)
,p_name=>'Click Class'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(41772064171015903)
,p_event_id=>wwv_flow_imp.id(41771965271015902)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(41771803689015901)
,p_process_sequence=>10
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'SET_CUSTOMER_ID'
,p_process_sql_clob=>'APEX_UTIL.SET_SESSION_STATE(''P15_CUSTOMER_ID'',APEX_APPLICATION.G_X01);'
,p_process_clob_language=>'PLSQL'
,p_required_patch=>wwv_flow_imp.id(37852063688108306)
,p_internal_uid=>41771803689015901
);
