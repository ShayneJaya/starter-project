prompt --application/shared_components/user_interface/templates/report/cards_alternative
begin
--   Manifest
--     ROW TEMPLATE: CARDS_ALTERNATIVE
--   Manifest End
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(43409002457973576)
,p_row_template_name=>'Cards Alternative'
,p_internal_name=>'CARDS_ALTERNATIVE'
,p_row_template1=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<li class="t-Cards-item #CARD_MODIFIERS#">',
'  <div class="t-Card">',
'    <a href="#CARD_LINK#" class="t-Card-wrap #CARD_COLOR#">',
