...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(38006847324106920)
,p_lov_name=>'FEEDBACK_RATING'
,p_lov_query=>'.'||wwv_flow_imp.id(38006847324106920)||'.'
,p_location=>'STATIC'
,p_version_scn=>44864188261262
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(38007169563106920)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(38007591098106919)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(38007916544106918)
