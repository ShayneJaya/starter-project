...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(46198080197375884)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46198392469375886)
,p_plugin_id=>wwv_flow_imp.id(46198080197375884)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46198695695375887)
,p_plugin_id=>wwv_flow_imp.id(46198080197375884)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46198902346375888)
,p_plugin_id=>wwv_flow_imp.id(46198080197375884)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46199270168375889)
,p_plugin_id=>wwv_flow_imp.id(46198080197375884)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46199511137375890)
,p_plugin_id=>wwv_flow_imp.id(46198080197375884)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46199882642375891)
,p_plugin_id=>wwv_flow_imp.id(46198080197375884)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46200195755375892)
,p_plugin_id=>wwv_flow_imp.id(46198080197375884)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46200434582375893)
,p_plugin_id=>wwv_flow_imp.id(46198080197375884)
,p_attribute_scope=>'COMPONENT'
