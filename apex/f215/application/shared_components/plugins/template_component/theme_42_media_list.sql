...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(46200786013375899)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1846219135313259559)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1846218580301259558)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46201428257375913)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46201782447375914)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46202056584375915)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46202313828375916)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46202629236375917)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(46202056584375915)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1846219135313259559)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46202949348375918)
,p_plugin_attribute_id=>wwv_flow_imp.id(46202629236375917)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46203302500375919)
,p_plugin_attribute_id=>wwv_flow_imp.id(46202629236375917)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46203780837375920)
,p_plugin_attribute_id=>wwv_flow_imp.id(46202629236375917)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46204192225375921)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(46202629236375917)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46204408324375922)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46204722774375923)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46205004719375924)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46205356070375925)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46205678413375926)
,p_plugin_attribute_id=>wwv_flow_imp.id(46205356070375925)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46206047112375927)
,p_plugin_attribute_id=>wwv_flow_imp.id(46205356070375925)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46206427914375928)
,p_plugin_attribute_id=>wwv_flow_imp.id(46205356070375925)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46206836225375929)
,p_plugin_attribute_id=>wwv_flow_imp.id(46205356070375925)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46207239785375930)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(46202313828375916)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1846218580301259558)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46207501042375931)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46207862457375932)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46208171416375933)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46208471260375934)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46208712094375935)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46209034163375936)
,p_plugin_attribute_id=>wwv_flow_imp.id(46208712094375935)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46209442490375937)
,p_plugin_attribute_id=>wwv_flow_imp.id(46208712094375935)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46209836700375938)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46210169915375939)
,p_plugin_attribute_id=>wwv_flow_imp.id(46209836700375938)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46210510488375940)
,p_plugin_attribute_id=>wwv_flow_imp.id(46209836700375938)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46210923160375941)
,p_plugin_attribute_id=>wwv_flow_imp.id(46209836700375938)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46211333491375942)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46211614198375943)
,p_plugin_attribute_id=>wwv_flow_imp.id(46211333491375942)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46212056582375944)
,p_plugin_attribute_id=>wwv_flow_imp.id(46211333491375942)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46212448195375945)
,p_plugin_attribute_id=>wwv_flow_imp.id(46211333491375942)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46212861270375946)
,p_plugin_attribute_id=>wwv_flow_imp.id(46211333491375942)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46213201961375947)
,p_plugin_attribute_id=>wwv_flow_imp.id(46211333491375942)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46213664410375948)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46213920000375949)
,p_plugin_attribute_id=>wwv_flow_imp.id(46213664410375948)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46214395944375951)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1846422187470406187)
,p_plugin_id=>wwv_flow_imp.id(46200786013375899)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
