...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(46182852716375780)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46183142497375807)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46183421046375811)
,p_plugin_attribute_id=>wwv_flow_imp.id(46183142497375807)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46183804753375815)
,p_plugin_attribute_id=>wwv_flow_imp.id(46183142497375807)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46184251905375816)
,p_plugin_attribute_id=>wwv_flow_imp.id(46183142497375807)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46184620307375818)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(46183142497375807)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46184925680375819)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46185227510375820)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46185518980375822)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46185803808375823)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46186195408375824)
,p_plugin_attribute_id=>wwv_flow_imp.id(46185803808375823)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46186523130375825)
,p_plugin_attribute_id=>wwv_flow_imp.id(46185803808375823)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46186952606375826)
,p_plugin_attribute_id=>wwv_flow_imp.id(46185803808375823)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46187306969375827)
,p_plugin_attribute_id=>wwv_flow_imp.id(46185803808375823)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46187738234375828)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46188023711375829)
,p_plugin_attribute_id=>wwv_flow_imp.id(46187738234375828)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46188490208375830)
,p_plugin_attribute_id=>wwv_flow_imp.id(46187738234375828)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46188871623375831)
,p_plugin_attribute_id=>wwv_flow_imp.id(46187738234375828)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46189241888375833)
,p_plugin_attribute_id=>wwv_flow_imp.id(46187738234375828)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46189671814375834)
,p_plugin_attribute_id=>wwv_flow_imp.id(46187738234375828)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46190047006375835)
,p_plugin_attribute_id=>wwv_flow_imp.id(46187738234375828)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(46190440054375836)
,p_plugin_attribute_id=>wwv_flow_imp.id(46187738234375828)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(46190821454375837)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1846233697023489542)
,p_plugin_id=>wwv_flow_imp.id(46182852716375780)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
