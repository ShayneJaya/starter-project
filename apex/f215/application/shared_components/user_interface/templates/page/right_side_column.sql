...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(46011364998375327)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46011621440375328)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46011946846375329)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46012251519375329)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46012553088375330)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46012891956375330)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46013183768375331)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46013475693375331)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46013756427375332)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46014033815375333)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46014323730375333)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46014611757375334)
,p_page_template_id=>wwv_flow_imp.id(46011364998375327)
