...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(46020527009375347)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46020899600375348)
,p_page_template_id=>wwv_flow_imp.id(46020527009375347)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46021153986375349)
,p_page_template_id=>wwv_flow_imp.id(46020527009375347)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46021475720375350)
,p_page_template_id=>wwv_flow_imp.id(46020527009375347)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46021772000375350)
,p_page_template_id=>wwv_flow_imp.id(46020527009375347)
,p_name=>'Body Footer'
