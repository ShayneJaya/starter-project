...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(46032094963375374)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46032380916375375)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46032657795375376)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46032984990375376)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46033270976375377)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46033527305375377)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46033864017375378)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46034163452375378)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46034417248375379)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46034703482375380)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46035020236375380)
,p_page_template_id=>wwv_flow_imp.id(46032094963375374)
