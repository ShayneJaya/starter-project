...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(46028622263375367)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46028983677375368)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46029298496375369)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46029526963375369)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46029896033375370)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46030123788375370)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46030443859375371)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46030723488375371)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46031083183375372)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46031320445375373)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46031676282375373)
,p_page_template_id=>wwv_flow_imp.id(46028622263375367)
