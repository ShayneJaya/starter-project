...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(46007637688375318)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46007965455375320)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46008285678375320)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46008505107375321)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46008846343375321)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46009191397375322)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46009450034375322)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46009738647375323)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46010020901375324)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46010359046375324)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46010665466375325)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46010940908375325)
,p_page_template_id=>wwv_flow_imp.id(46007637688375318)
