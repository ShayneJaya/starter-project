...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46083949426375501)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46084256190375503)
,p_plug_template_id=>wwv_flow_imp.id(46083949426375501)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46084580885375503)
,p_plug_template_id=>wwv_flow_imp.id(46083949426375501)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46084868644375504)
,p_plug_template_id=>wwv_flow_imp.id(46083949426375501)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46085111709375504)
,p_plug_template_id=>wwv_flow_imp.id(46083949426375501)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46085408509375505)
,p_plug_template_id=>wwv_flow_imp.id(46083949426375501)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
