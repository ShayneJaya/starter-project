...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46104529873375548)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46104854995375549)
,p_plug_template_id=>wwv_flow_imp.id(46104529873375548)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46105197574375549)
,p_plug_template_id=>wwv_flow_imp.id(46104529873375548)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46105451849375550)
,p_plug_template_id=>wwv_flow_imp.id(46104529873375548)
,p_name=>'Sub Regions'
