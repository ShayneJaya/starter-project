...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46102039298375543)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46102374148375543)
,p_plug_template_id=>wwv_flow_imp.id(46102039298375543)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46102638186375544)
,p_plug_template_id=>wwv_flow_imp.id(46102039298375543)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46102920788375544)
,p_plug_template_id=>wwv_flow_imp.id(46102039298375543)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46103247586375545)
,p_plug_template_id=>wwv_flow_imp.id(46102039298375543)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46103556459375546)
,p_plug_template_id=>wwv_flow_imp.id(46102039298375543)
,p_name=>'Sub Regions'
