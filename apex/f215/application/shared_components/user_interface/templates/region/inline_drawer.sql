...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46087447611375510)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46087764681375511)
,p_plug_template_id=>wwv_flow_imp.id(46087447611375510)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46088097026375511)
,p_plug_template_id=>wwv_flow_imp.id(46087447611375510)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46088344284375512)
,p_plug_template_id=>wwv_flow_imp.id(46087447611375510)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46088677853375512)
,p_plug_template_id=>wwv_flow_imp.id(46087447611375510)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46088935009375513)
,p_plug_template_id=>wwv_flow_imp.id(46087447611375510)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46089226636375513)
,p_plug_template_id=>wwv_flow_imp.id(46087447611375510)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46089502257375514)
,p_plug_template_id=>wwv_flow_imp.id(46087447611375510)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46089815028375514)
,p_plug_template_id=>wwv_flow_imp.id(46087447611375510)
,p_name=>'Sub Regions'
