...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46074136806375478)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46074444047375479)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46074712766375480)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46075096138375480)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46075368499375481)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46075607415375481)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46075963744375482)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46076288221375482)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46076543220375483)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46076846465375484)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46077120640375484)
,p_plug_template_id=>wwv_flow_imp.id(46074136806375478)
,p_name=>'Sub Regions'
