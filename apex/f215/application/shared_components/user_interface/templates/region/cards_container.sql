...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46067687528375463)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46067987124375464)
,p_plug_template_id=>wwv_flow_imp.id(46067687528375463)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46068299473375465)
,p_plug_template_id=>wwv_flow_imp.id(46067687528375463)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46068557944375465)
,p_plug_template_id=>wwv_flow_imp.id(46067687528375463)
,p_name=>'Sub Regions'
