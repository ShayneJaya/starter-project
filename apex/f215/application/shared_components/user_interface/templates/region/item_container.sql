...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46099547302375536)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46099812234375537)
,p_plug_template_id=>wwv_flow_imp.id(46099547302375536)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46100117202375538)
,p_plug_template_id=>wwv_flow_imp.id(46099547302375536)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46100489261375538)
,p_plug_template_id=>wwv_flow_imp.id(46099547302375536)
,p_name=>'Button Start'
