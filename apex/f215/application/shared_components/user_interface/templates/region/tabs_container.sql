...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46117089948375577)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46117332919375578)
,p_plug_template_id=>wwv_flow_imp.id(46117089948375577)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46117659532375579)
,p_plug_template_id=>wwv_flow_imp.id(46117089948375577)
,p_name=>'Tabs'
