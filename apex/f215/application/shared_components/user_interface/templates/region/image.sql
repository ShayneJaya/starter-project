...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(46053591159375430)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46053843312375431)
,p_plug_template_id=>wwv_flow_imp.id(46053591159375430)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(46054188980375432)
,p_plug_template_id=>wwv_flow_imp.id(46053591159375430)
,p_name=>'Sub Regions'
